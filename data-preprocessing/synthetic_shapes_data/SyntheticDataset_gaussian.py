...
import cv2
import shutil
DATA_PATH = '/home/baudoin/data/synthetic_shapes' # path for datasets
EXPER_PATH = '/home/baudoin/logs' # path for saving checkpoints
SYN_TMPDIR = '/home/baudoin/data/synthetic_shapes'  # path for dumping synthetic data
...
class SyntheticDataset_gaussian(data.Dataset):
    ...
    default_config = {
        ...
        "generation": {
            "split_sizes": {"training": 1000, "validation": 20, "test": 100},
            "image_size": [960, 1280],
            "random_seed": 0,
            "params": {
                "generate_background": {
    ...
    def __getitem__(self, index):
        ...
        from utils.data_tools import np_to_tensor
        ...
        if self.gaussian_label:
            ...
            from utils.data_tools import get_labels_bi
        ...
        if self.config["warped_pair"]["enable"]:
            from utils.data_tools import warpLabels
